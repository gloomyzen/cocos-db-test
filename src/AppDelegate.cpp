...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    GET_DATABASE_MANAGER().addDatabase(
        databaseManager::eDatabaseList::BUILDING_DB, "properties/database/buildings/db.json", new buildingsDatabase());
    ...
    // register all states
    GET_SCENES_FACTORY().registerState("battleScene", []() { return new mb::battleModule::battleScene(); });
